    ...
    "use strict";
        ...
        function facebook() {
			if ($('#fb-widget').length) {
				...
				var fb_page = '<div class="fb-page" data-tabs="timeline,events,messages" data-href="'+fb_page_url+'" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore">Facebook</div></div>';
